...
namespace TH.WebUI.Filters
{
    ...
    public sealed class InitializeSimpleMembershipAttribute : ActionFilterAttribute
    {
        ...
        private class SimpleMembershipInitializer
        {
            ...
            {
                Database.SetInitializer<THDbContext>(null);

                try
                {
                    using (var context = new THDbContext())
                    {
                    ...
                    WebSecurity.InitializeDatabaseConnection("MySameCity", "User", "UserId", "UserName", autoCreateTables: true);
                }
                catch (Exception ex)
                {
