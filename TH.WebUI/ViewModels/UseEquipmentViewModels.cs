...
{
    public class UseEquipmentIndexViewModel
    {
    ...
    public class UseEquipmentCreateViewModel
    {
        [DisplayName("标题")]
        [Required]
        public string Title { get; set; }
    ...
    public class UseEquipmentDetailsViewModel
    {
        public string Title { get; set; }
    ...
    public class UseEquipmentEditViewModel
    {
        [UIHint("HiddenInput")]
        [Required]
        public int Id { get; set; }
